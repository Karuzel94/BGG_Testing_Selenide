...
public class LoginStepDefs extends BaseTest implements En {
    ...
    public LoginStepDefs() {
        Given("^Log with defined credentials$", () -> {signInFragment.clickSignInButton();
    ...
    public void check_if_the_user_something_was_logged_in(String strArg1) {
        Assertions.assertThat(userMenuFragment.getUserName()).isEqualTo(strArg1);
    }
    ...
    public void check_if_there_is_an_error() {
        Assertions.assertThat(signInFragment.getErrorText()).isEqualTo("Invalid username or password");
